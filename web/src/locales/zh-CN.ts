export default {
  ...
  keys: {
    ...
    validShort: "有效",
    coolingShort: "冷却中",
    autoDisabledShort: "自动禁用",
    invalidShort: "无效",
    statusCodeLabel: "状态码",
    cooldownRemaining: "剩余 {seconds}s",
    clearCooldown: "清除冷却",
    clearCooldownShort: "清除冷却",
    confirmClearCooldown: '确定要清除密钥"{key}"的冷却状态吗？',
    ...
    priority: "优先级",
    editPriority: "编辑优先级",
    enterPriority: "请输入优先级（0-100）",
    priorityUpdated: "优先级已更新",
    manuallyDisabled: "手动禁用",
    manuallyEnabled: "手动启用",
    enableKey: "启用密钥",
    disableKey: "禁用密钥",
  ...
  settings: {
    ...
    keySelectionStrategyDesc: "round-robin: 轮询选择；sticky: 优先使用上次成功的密钥（缓存亲和性）",
    cooldownDurationSeconds: "冷却时长（秒）",
    cooldownDurationSecondsDesc: "检测到 429 限流错误时，自动冷却密钥的时长，0 表示禁用冷却机制",
    ...
    importSettings: "导入设置",
    exportSettings: "导出设置",
    strategyRoundRobin: "轮询（Round Robin）- 按顺序依次选择密钥",
    strategySticky: "缓存亲和（Sticky）- 优先使用上次成功的密钥",
    settingsSaved: "设置已保存",
    settingsReset: "设置已重置",
