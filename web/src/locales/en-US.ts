export default {
  ...
  keys: {
    ...
    restoreShort: "↻",
    validShort: "OK",
    coolingShort: "Cooling",
    autoDisabledShort: "Disabled",
    invalidShort: "NG",
    statusCodeLabel: "Status",
    cooldownRemaining: "{seconds}s left",
    clearCooldown: "Clear Cooldown",
    clearCooldownShort: "Clear CD",
    confirmClearCooldown: 'Are you sure to clear cooldown for key "{key}"?',
