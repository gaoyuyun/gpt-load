...
var MessagesJaJP = map[string]string{
	...
	"config.cooldown_status_codes":           "クールダウン対象ステータスコード",
	"config.cooldown_status_codes_desc":      "これらの HTTP ステータスコードに一致した場合、現在のキーをクールダウン状態にします。複数コードはカンマ、空白、改行で区切れます。デフォルトは 429。",
	"config.disable_status_codes":            "自動無効化ステータスコード",
	"config.disable_status_codes_desc":       "これらの HTTP ステータスコードに一致した場合、現在のキーを自動的に無効化し、その理由を記録します。複数コードはカンマ、空白、改行で区切れます。デフォルトは 402。",
	"config.direct_fail_status_codes":        "即時失敗ステータスコード",
	"config.direct_fail_status_codes_desc":   "これらの HTTP ステータスコードに一致した場合、他のキーへのリトライを行わず、上流エラーをそのまま返します。現在のキーはペナルティを受けません。複数コードはカンマ、空白、改行で区切れます。デフォルトは 413。",
